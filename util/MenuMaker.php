...
class MenuMaker{
    ...
    public static function children($userId,$id){
        $nodes = array();
    ...
    public static function getMenus($userId,$parent){
        $rows  = Menu::find()->
        from('menu')->
        innerJoin('rol', 'rol.id_rol = menu.id_rol')->
